#!/usr/bin/env python3
"""
harrisonsdirect-co-uk Product Extraction Script
Auto-generated by supplier_script_generator.py on 2025-07-05T21:37:38.492242

This script provides product data extraction for https://www.harrisonsdirect.co.uk/
...
class Harrisonsdirect_Co_UkProductExtractor:
    """Product extraction for harrisonsdirect-co-uk"""
...
async def extract_harrisonsdirect_co_uk_products(page, start_page=1, max_pages=None):
    """
    ...
    """
    try:
        extractor = Harrisonsdirect_Co_UkProductExtractor()
