...
Auto-generated by IntelligentSupplierScriptGenerator on 2025-07-08T18:10:54.735417
...
SUBMIT_SELECTOR = "button[type='submit'], .btn.btn-primary, .btn-primary, button:has-text('Login'), button:has-text('Sign in'), input[type='submit']"
...
class Poundwholesale_Co_UkLogin:
    ...
    async def perform_login(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                # First try to dismiss any modal overlays that might be blocking clicks
