...
"""
    ...
    def sync_claude_md(self):
        ...
        print("📄 Generating claude.md (filtered for automation)...")
    ...
    def sync_docs(self):
        ...
        print("📄 Generating docs/CLAUDE_STANDARDS.md (full copy for discoverability)...")
    ...
    def sync_all(self):
        ...
        print("🔄 Syncing Claude Standards files...")
        ...
        try:
            ...
            if success:
                ...
                print("\n📋 Generated files:")
                print(f"   • {self.claude_md_target} (automation target)")
                print(f"   • {self.docs_target} (developer discoverability)")
                print(f"\n💡 Source of truth: {self.source_file}")
    ...
    def check_sync_needed(self):
        ...
        try:
            ...
            if claude_needs_sync or docs_needs_sync:
                ...
                print(f"❌ Sync needed for: {', '.join(reasons)}")
                return False
            else:
